...
const WEEKLY_READINGS = [
  ...
  { title: 'Recovering a Sense of Safety', author: 'By: Jhinova Bay, PhD', description: 'Establish a foundation of safety to explore your creativity without fear.', category: 'Week 1', imageUrl: 'https://i.imgur.com/TUboIfF.jpeg', slug: 'recovering-safety', markdownPath: '/readings/recovering-safety.md' },
