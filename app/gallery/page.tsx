...
const paintings: Painting[] = [
  ...
  { title: 'Combini Onigiri', artist: 'jutt100', year: '2023', era: 'Art', size: 'medium', image: 'https://raw2.seadn.io/ethereum/0x495f947276749ce646f68ac8c248420045cb7b5e/595d5d41f16c974c291c3e1087425a/c3595d5d41f16c974c291c3e1087425a.gif', desc: 'A traditional snack helping millions of hard workers keep doing their jobs all over the world on a daily basis. Onigiri can be filled with anything, from simple surimi to vegetables and kimchi.', zoraUrl: 'https://sealed.art/nft/0x495f947276749ce646f68ac8c248420045cb7b5e/10639796756093647194021365287053865911700552177464675414670510296642034335760' },
  ...
  { title: 'Blue II', artist: 'Metawave Studio', year: '2025', era: 'Concept Art', size: 'small', image: 'https://scontent-iad4-1.choicecdn.com/-/rs:fit:1200:1200/f:best/aHR0cHM6Ly9tYWdpYy5kZWNlbnRyYWxpemVkLWNvbnRlbnQuY29tL2lwZnMvYmFmeWJlaWIzN3M0YWVoZW1vbWtvZ3ZjaWIyZHNtMmtnMzM3dGJ1N2JmcXdxaHV6em55Ym5hN2Z6dmU=', desc: 'Blue waited... waited for something exciting to happen. But she wore a skull necklace that stunk of bad spirits.', zoraUrl: 'https://zora.co/coin/base:0xe7fb18603411ce7057a83f872538caabcf0f6abe' },
  ...
  { title: 'VIBE-98 "Park"', artist: 'SHOWADOT', year: '2023', era: 'Art', size: 'wide', image: 'https://arweave.net/hqIt7ZU2Es1nZ4Jc8NXEsrfGoVahp7-UEgVLiFqi2SA', desc: 'Colors used: 16 of 16. A 16-bit background image originally created for an unreleased PC-98 style game.', zoraUrl: 'https://sealed.art/nft/0xd1b39ac161192e745dd739d73f9ead92151f43e2/2' },
  ...
  { title: 'VIBE-98 "Empty Classroom"', artist: 'SHOWADOT', year: '2023', era: 'Art', size: 'wide', image: 'https://arweave.net/YnZTVagWMnWqWfplNeFCMqEl4aXOBoKPWZfQouz0c0c', desc: 'Colors used: 15 of 16. 16-bit background image originally made for the unreleased PC-98 style game.', zoraUrl: 'https://sealed.art/nft/0xd1b39ac161192e745dd739d73f9ead92151f43e2/1' },
