...
export const week5Sections: JournalSection[] = [
  ...
  {
    id: 'examine-virtues',
    title: 'Examine Blocking "Virtues"',
    icon: ListIcon,
    type: 'list',
    instructions: 'List five "virtues" that may actually block your creativity. Being "responsible," "sensible," "mature" — these can all be cloaks for creative avoidance.',
    listCount: 5,
    listLabels: ['Virtue 1', 'Virtue 2', 'Virtue 3', 'Virtue 4', 'Virtue 5'],
  },
  {
    id: 'forbidden-pleasures',
    title: 'Forbidden Pleasures List',
    icon: HeartIcon,
    type: 'numbered-list',
    instructions: 'List ten pleasures that feel forbidden or indulgent to you. Allow yourself one this week.',
    listCount: 10,
    listLabels: Array.from({ length: 10 }, (_, i) => `${i + 1}.`),
  },
  {
    id: 'creative-u-turns',
    title: 'Creative U-turns',
    icon: TextIcon,
    type: 'text',
    instructions: 'Describe times you have made a "creative U-turn" — started something creative and then sabotaged it. What happened? What was your excuse?',
    placeholder: 'Describe your creative U-turns...',
  },
];
